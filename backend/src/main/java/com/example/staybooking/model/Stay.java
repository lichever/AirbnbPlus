...
//  no-argument constructor is a requirement (tools like Hibernate use reflection on this constructor to instantiate objects
  public Stay() {
  }
  ...
  //only setter for StayService's add function
